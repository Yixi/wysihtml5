...
(function(wysihtml5) {
  ...
  // extend the 'SPAN' to the Tag Group for the removeFormat command to remove the format block style.   ---By Yixi.
      BLOCK_ELEMENTS_GROUP    = ["H1", "H2", "H3", "H4", "H5", "H6", "P", "BLOCKQUOTE", "DIV","SPAN"];
